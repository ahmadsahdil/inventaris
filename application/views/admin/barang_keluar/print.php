  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Download Berdasarkan Nama Posko / Tanggal Distribusi </h4>
      </div>
      <div class="modal-body">
           <?php echo form_open('report/tampil_distribusi_bantuan/'); ?>
           <div class="form-group">
                    ...
                    <!-- <option value="semua">Semua</option> -->
                     ...
                     <option value="<?php 
                      echo $lihat->id_posko?>"><?php echo $lihat->nama_posko?></option>
                        <?php }; ?>
                      </select>
                      </div>
                      <br>
                       ...
                       <br>
                        <!--  <button type="submit" name="simpan" class="btn btn-outline  pull-right" id="simpan" ><i class="fa fa-print"></i>  Download</button> -->
                         <button type="submit" name="export" class="btn btn-outline  pull-right"  id="export" ><i class="fa fa-file-excel-o"></i>  Export Excel</button>
                           <a href="<?php echo base_url(); ?>report/tampil_distribusi" class="btn btn-sm btn-primary "><i class="fa fa-file-excel-o"></i> Cetak Semua</a>
