  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Download Berdasarkan Nama Korlap</h4>
      </div>
      <div class="modal-body">
           <?php echo form_open('report/tampil_pelanggan_korlap/'); ?>
                      ...
                      echo $lihat->id_user?>"><?php echo $lihat->nama?></option>
                        ...
                        <!--  <button type="submit" name="simpan" class="btn btn-outline  pull-right" id="simpan" ><i class="fa fa-print"></i>  Download</button> -->
                         <button type="submit" name="export" class="btn btn-outline  pull-right"  id="export" ><i class="fa fa-file-excel-o"></i>  Export Excel</button>
                           <a href="<?php echo base_url(); ?>report/tampil_pelanggan" class="btn btn-sm btn-primary "><i class="fa fa-file-excel-o"></i> Cetak Semua</a>
