  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Download Berdasarkan Wilayah</h4>
      </div>
      <div class="modal-body">
           <?php echo form_open('report/tampil_infrastruktur_wilayah/'); ?>
           <div class="form-group">
                    ...
                    <!-- <option value="semua">Semua</option> -->
                     ...
                     <option value="<?php 
                      echo $lihat->id_wilayah?>"><?php echo $lihat->nama_wilayah?></option>
                        <?php }; ?>
                      </select>
                      </div>
